...
var minorCount = { propertyName: 'minorCount', modelName: '@MinorCount', displayName: 'Minor Count', editor: analytics_widgets_1.editorTemplates.getEditor('numeric'), localizationId: 'DevExpress.XtraCharts.AxisBase.MinorCount' }, interlaced = { propertyName: 'interlaced', modelName: '@Interlaced', displayName: 'Interlaced', from: analytics_utils_1.parseBool, defaultVal: false, editor: analytics_widgets_1.editorTemplates.getEditor('bool'), localizationId: 'DevExpress.XtraCharts.AxisBase.Interlaced' }, interlacedColor = { propertyName: 'interlacedColor', modelName: '@InterlacedColor', displayName: 'Interlaced Color', editor: analytics_widgets_1.editorTemplates.getEditor('customColorEditor'), from: analytics_utils_1.colorFromString, localizationId: 'DevExpress.XtraCharts.AxisBase.InterlacedColor' };
...
exports.constantLineSerializationsInfo = [axisValueSerializable, _common_1.name, _common_1.visible, _common_1.color, _common_1.showInLegend, exports.legendName, _common_1.legendText, showBehind, _common_1.tag];
