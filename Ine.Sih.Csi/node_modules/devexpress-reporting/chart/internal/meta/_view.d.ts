/**
* DevExpress HTML/JS Reporting (chart\internal\meta\_view.d.ts)
* Version:  20.2.5
...
export declare var paneName: ISerializationInfo;
export declare var axisXName: ISerializationInfo;
export declare var axisYName: ISerializationInfo;
export declare var fillStyleInfo: (ISerializationInfo | {
    propertyName: string;
    modelName: string;
    displayName: string;
