...
var ObjectDataSourceEditor = (function (_super) {
    ...
    ObjectDataSourceEditor.createObjectDataSourceInfo = function (objectDataSourceWizard, objectDataSource) {
        var deferred = $.Deferred();
        _reportDataSourceService_1.ReportDataSourceService.getObjectDataSourceBase64(JSON.stringify(objectDataSourceWizard))
    ...
    ObjectDataSourceEditor.prototype.applyDataSourceWizardChanges = function (dataSourceWizardModel) {
        ...
        var deferred = $.Deferred();
        ObjectDataSourceEditor.createObjectDataSourceInfo(dataSourceWizardModel.objectDataSourceWizard, objectDataSource)
            .done(function (info) {
            if (dataSourceInfo) {
