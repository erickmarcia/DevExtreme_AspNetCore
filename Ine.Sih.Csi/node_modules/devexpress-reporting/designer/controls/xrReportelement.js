...
var XRReportElementViewModel = (function (_super) {
    ...
    XRReportElementViewModel.prototype._addExpressionActions = function (propertyName) {
        ...
        var convertToMenuAction = function (item) {
            ...
            var expressionEditor = hasInnerItems ? null : new reportExpressionEditor_1.ReportExpressionEditorAdapter(ko.observable(item.expressionObj['serializationInfo'] && item.expressionObj['serializationInfo']['valuesArray'] || []), ko.observable(item.expressionObj));
            ...
            var menuAction = {
                ...
                customTemplate: hasInnerItems ? null : {
                    name: 'dxrd-reportexpression-popup',
    ...
    XRReportElementViewModel.prototype.getActionClassName = function (propertyName) {
        var result = {};
        if (this.isStyleProperty(propertyName) && this.stylePriority[this._getStylePriorityPropertyName(propertyName)]())
            result['dxrd-editormenu-usestyle'] = true;
        if (this.isPropertyModified(propertyName))
            result['dxrd-editormenu-modified'] = true;
...
var reportExpressionEditor_1 = require("../widgets/reportExpressionEditor");
