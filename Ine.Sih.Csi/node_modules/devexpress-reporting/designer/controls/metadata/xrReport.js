...
exports.snapGridSize = { propertyName: 'snapGridSize', modelName: '@SnapGridSize', defaultVal: 12.5, from: analytics_utils_1.floatFromModel, editor: analytics_widgets_1.editorTemplates.getEditor('numeric'), displayName: 'Snap Grid Size', localizationId: 'DevExpress.XtraReports.UI.XtraReport.SnapGridSize' };
...
exports.language = {
    propertyName: 'language', displayName: 'Language', defaultVal: metadata_1.defaultCulture, localizationId: 'DevExpress.XtraReports.UI.XtraReport.XRLanguage', localizable: true, editor: editorTemplates_1.designerEditorTemplates.getEditor('dataSourceSelectBox'), values: metadata_1.availableCultures
};
...
exports.reportSerializationInfo = [
    ...
    analytics_internal_1.extend({}, metadata_2.expressionableFont, { defaultVal: 'Times New Roman, 9pt' }),
