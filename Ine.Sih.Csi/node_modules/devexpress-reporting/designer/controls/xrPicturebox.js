    ...
    function XRPictureBoxViewModel(model, parent, serializer) {
        ...
        _this._disposables.push(ko.computed(function () {
            ...
            img.onload = function () {
                ...
                _this._disposables.push(ko.computed(function () {
                    originalImageWidth(analytics_internal_1.pixelToUnits(img.width, report.measureUnit(), 1));
                    originalImageHeight(analytics_internal_1.pixelToUnits(img.height, report.measureUnit(), 1));
                }));
            };
