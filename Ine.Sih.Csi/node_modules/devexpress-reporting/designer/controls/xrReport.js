    ...
    function ReportViewModel(report, serializer) {
        ...
        _this._disposables.push(_this.paperKind.subscribe(function (newVal) {
            if (newVal !== 'Custom') {
                ...
                _this.pageHeight(analytics_internal_1.roundingTwoDecimals((_this.landscape() ? size.width : size.height) * (_this._innerDpi.peek() / 100)));
                _this.pageWidth(analytics_internal_1.roundingTwoDecimals((_this.landscape() ? size.height : size.width) * (_this._innerDpi.peek() / 100)));
            }
        }));
