...
var XRCharacterCombSurface = (function (_super) {
    ...
    function XRCharacterCombSurface(control, context) {
        ...
        _this._disposables.push(_this.vertical = ko.computed(function () {
            ...
            var vertical = Math.floor(analytics_internal_1.roundingTwoDecimals((_this.rect().height - _borderWidth) / fullCellHeight));
            if (analytics_internal_1.roundingTwoDecimals(_this.rect().height - (vertical * fullCellHeight + _borderWidth)) >= analytics_internal_1.roundingTwoDecimals(_this.cellSize.height() * context.zoom() - _borderWidth)) {
                vertical += 1;
            }
            return vertical;
        }));
        _this._disposables.push(_this.horizontal = ko.computed(function () {
            ...
            var horizontal = Math.floor(analytics_internal_1.roundingTwoDecimals((_this.rect().width - _borderWidth) / fullCellWidth));
            if (analytics_internal_1.roundingTwoDecimals(_this.rect().width - (horizontal * fullCellWidth + _borderWidth)) >= analytics_internal_1.roundingTwoDecimals(_this.cellSize.width() * context.zoom() - _borderWidth)) {
                horizontal += 1;
            }
            return horizontal;
        }));
