/**
* DevExpress HTML/JS Reporting (designer\wizard\pageId.d.ts)
* Version:  20.2.5
* Build date: Jan 18, 2021
* Copyright (c) 2012 - 2021 Developer Express Inc. ALL RIGHTS RESERVED
* License: https://www.devexpress.com/Support/EULAs/universal.xml
*/
export declare var LegacyReportWizardPageId: {
...
export declare var ReportWizardPageId: {
...
export declare var FullscreenReportWizardPageId: {
    SelectReportTypePage: string;
...
export declare var FullscreenReportWizardSectionId: {
    ChooseAvailableDataSourcePage: string;
    SelectLabelTypePage: string;
    CustomizeLabelPage: string;
