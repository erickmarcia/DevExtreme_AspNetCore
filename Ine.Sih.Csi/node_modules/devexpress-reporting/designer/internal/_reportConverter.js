...
var ReportConverter = (function () {
    function ReportConverter(_controlsHelper, _undoEngine, _dataBindingMode) {
        ...
        this.popupOptions = {
            ...
            confirmMessage: analytics_internal_1.formatUnicorn(analytics_utils_1.getLocalization('The {0} contains bindings. Do you want to convert them to expressions?', 'ReportStringId.UD_Msg_ConvertBindings'), analytics_utils_1.getLocalization('Report', 'DevExpress.XtraReports.UI.XtraReport')),
            linkText: analytics_utils_1.getLocalization('Learn more about the expressions...', 'ReportStringId.UD_Msg_ConvertBindings_LinkText'),
            ...
            buttons: [
                ...
                { toolbar: 'bottom', location: 'before', widget: 'dxCheckBox', options: { value: this._notShowAgain, text: analytics_utils_1.getLocalization("Remember my choice and don't ask me again.", 'ReportStringId.UD_Msg_ConvertBindings_RememberMyChoice') } }
            ]
        };
        this._mapFontObj(this._defaultFormatting, new analytics_widgets_internal_1.FontModel(ko.observable('')));
        this._mapPaddingObj(this._defaultFormatting, analytics_elements_1.PaddingModel.from('0,0,0,0'));
    }
