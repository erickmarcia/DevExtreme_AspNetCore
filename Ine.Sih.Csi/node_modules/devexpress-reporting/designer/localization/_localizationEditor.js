...
var LocalizationEditor = (function (_super) {
    ...
    LocalizationEditor.prototype._getScrollOffset = function (elementPosition, scrollOffset, visibleSize, fullSize) {
    ...
    LocalizationEditor.prototype._subscribeFocused = function () {
        ...
        return this._options.selection.focused.subscribe(function (newVal) {
            ...
            if (newVal['absolutePosition']) {
                var currentPosition = newVal['absolutePosition'];
                var scrollLeft = _this._getScrollOffset(currentPosition.x(), _this._viewPort.scrollLeft, _this._viewPort.clientWidth, _this._viewPort.scrollWidth);
                var scrollTop = _this._getScrollOffset(currentPosition.y(), _this._viewPort.scrollTop, _this._viewPort.clientHeight, _this._viewPort.scrollHeight);
                if (_this._viewPort.scrollTo) {
                    _this._viewPort.scrollTo({
                        left: scrollLeft,
                        top: scrollTop
                    });
                }
                else {
                    _this._viewPort.scrollLeft = scrollLeft;
                    _this._viewPort.scrollTop = scrollTop;
                }
            }
        });
    };
        ...
        this.localizationItems(this._localizableControls().map(function (component) {
            ...
            return {
                ...
                visible: ko.computed(function () {
                    return (_this.isDefaultLanguage() || !!_defaultText()) &&
                        (function (regex) {
    ...
    LocalizationEditor.prototype.start = function () {
        if (this._options.element) {
            ...
            this._viewPort = this._options.element.getElementsByClassName('dxrd-viewport')[0];
        }
