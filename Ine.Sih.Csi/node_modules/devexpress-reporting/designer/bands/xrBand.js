...
var BandViewModel = (function (_super) {
        ...
        if (_this.level) {
            ...
            _this._disposables.push(_this.level = ko.pureComputed({
                ...
                write: function (newVal) {
                    ...
                    _this.replaceArrays((_this.controlType === 'GroupHeaderBand' ? groupArray.reverse() : groupArray).filter(function (x) { return !!x; }), parentBands, _this);
                }
            }));
        }
    ...
    BandViewModel.prototype.replaceArrays = function (newArray, target, band) {
    ...
    BandViewModel.prototype.initHeight = function () {
        ...
        this._disposables.push(this.heightFromControls = ko.pureComputed(function () {
            ...
            if (analytics_internal_1.checkModelReady(_this.root)) {
                ...
                _heightFromControls = analytics_internal_1.roundingTwoDecimals(_heightFromControls);
