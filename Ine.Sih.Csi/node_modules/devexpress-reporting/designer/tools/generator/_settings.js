...
var WizardsInitializerSettings = (function () {
    ...
    WizardsInitializerSettings.prototype.createReportWizard = function (settings) {
        ...
        this.reportWizardOptions.dataSources = ko.pureComputed(function () {
            ...
            var dataSourcesWithOutDataFederation = result.filter(function (object) { return !(object.data instanceof dataFederation_1.DataFederationDataSource); });
            return dataSourcesWithOutDataFederation;
        });
