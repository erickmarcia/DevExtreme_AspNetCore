...
var ReportDesignerInitializer = (function (_super) {
    ...
    ReportDesignerInitializer.prototype.addFlagsAndInitProperties = function (element) {
        ...
        this.addElement('updateFont', function () { return function (values) {
            analytics_widgets_internal_1.availableFonts(values);
        }; });
        ...
        return (function (actions) {
            ...
            if (reportPreview) {
                actions.push({
                    ...
                    text: 'Preview',
                    displayText: function () { return analytics_utils_1.getLocalization('Preview', 'ReportStringId.RepTabCtl_Preview'); },
    ...
    ReportDesignerInitializer.prototype._patchReportBeforeRedesign = function (reportViewModel, state) {
        ...
        if (!state.newDataSource && reportViewModel.dataSource()) {
    ...
    ReportDesignerInitializer.prototype.addContextActions = function (func) {
        ...
        if (func === void 0) { func = function (settings) {
            ...
            settings.actionProviders = [new reportElementActions_1.ReportElementActions(_this.buildingModel.surface, _this.buildingModel.selection),
                ...
                new pivotGridActions_1.PivotGridActions(isDisabled)];
    ...
    ReportDesignerInitializer.prototype.addParts = function (func) {
        ...
        if (func === void 0) { func = function (parts) {
            ...
            var oldMenuPart = parts.filter(function (part) { return part.id === analytics_internal_1.DesignerBaseElements.MenuButton; })[0];
            var index = parts.indexOf(oldMenuPart);
            parts.splice(index, 1);
            parts.push({ id: reportDesignerElements_1.ReportDesignerElements.NavigationPanel, templateName: reportDesignerElements_1.ReportDesignerElements.NavigationPanel, model: _this.buildingModel.navigateByReports }, { id: null, templateName: reportDesignerElements_1.ReportDesignerElements.ReportDialog, model: _this.buildingModel.saveReportDialog }, { id: null, templateName: reportDesignerElements_1.ReportDesignerElements.ReportDialog, model: _this.buildingModel.saveReportDialogLight }, { id: null, templateName: reportDesignerElements_1.ReportDesignerElements.ReportDialog, model: _this.buildingModel.openReportDialog }, { id: reportDesignerElements_1.ReportDesignerElements.MenuButton, templateName: reportDesignerElements_1.ReportDesignerElements.MenuButton, model: _this.buildingModel }, _this._createChartDesignerPart(_this._reportcontext), { id: null, templateName: reportDesignerElements_1.ReportDesignerElements.ReportConverterDialog, model: reportConverter }, { id: null, templateName: reportDesignerElements_1.ReportDesignerElements.Parameters, model: _this.buildingModel.parameters });
            return parts;
        }; }
    ...
    ReportDesignerInitializer.prototype.addLocalization = function (localization) {
        if (localization) {
            analytics_utils_1.addCultureInfo({ messages: localization });
        }
        return this;
    };
    ReportDesignerInitializer.prototype.applyLocalizationToDevExtreme = function (currentCulture) {
        analytics_internal_1.applyLocalizationToDevExtreme(currentCulture);
        return this;
    };
    ...
    ReportDesignerInitializer.prototype.addLocalizationEditor = function (element) {
        var _this = this;
