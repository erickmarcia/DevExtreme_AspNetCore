...
<script type="text/html" id="dxrd-designer">
    <div data-bind="cssArray: [surfaceClass($element), { 'dx-accessibility': $data.accessibilityCompliant } ]">
...
<script type="text/html" id="dx-treelist-header-item">
    <div role="treeitem" class="dx-treelist-item dxd-list-item-back-color dxd-back-highlighted dx-accessibility-treelist-item dx-accessibility-focus-border-accented" data-bind="event: { dblclick: function() { $data.dblClickHandler ? $data.dblClickHandler($data) : $data.toggleCollapsed() } },
     styleunit: padding, css: { 'dx-treelist-item-selected dxd-state-selected': isSelected() || isMultiSelected() },
      attr: { 
          'aria-expanded': (hasItems && (!collapsed() ? 'true' : 'false')),
          'aria-selected': (isSelected() || isMultiSelected()) ? 'true' : 'false',
          'aria-level':level + 1,
          'aria-label': text,
          'aria-setsize': parent.items().length,
          'aria-posinset': parent.items.indexOf($data) + 1 }">
        <!-- ko if: $data.hasItems-->
        <div class="dx-treelist-collapsedbutton" data-bind="css: nodeImageClass, template: 'dxrd-svg-collapsed', click: toggleCollapsed"></div>
        <!-- /ko -->
...
<script type="text/html" id="dx-objectdatasource-datamembers-section">
    <div class="dx-objectdatasource-parameters-datamembers-section">
        <div class="dxd-border-primary" data-bind="dxList: { dataSource: dataMembers, selectedItems: selectedDataMembers, selectionMode: 'single', activeStateEnabled: false, focusStateEnabled: false, searchExpr: 'displayName', searchEnabled: true, noDataText: $root.dx._static.noDataText(), searchEditorOptions: { placeholder: $root.dx._static.searchPlaceholder() } }">
            <div data-options="dxTemplate : { name: 'item' }">
                <div data-bind="text: $data.displayName"></div>
            </div>
        </div>
...
<script type="text/html" id="dxrd-wizard-create-query-page">
    ...
    <div class="dxrd-querybuilder-popup" data-bind="dxPopup: popupViewModel($element)">
        ...
        <div class="dxrd-querybuilder-popup-content">
            <div style="height:100%;" data-bind="dxQueryBuilder: qbOptions"></div>
        </div>
        <!-- /ko -->
...
</script><script type='text/html' id='dxrd-checkboxcustomglyph'>
...
﻿<script type="text/html" id="dxrv-preview-date-range-mobile">
    <div class="dxrv-preview-date-range-mobile">
        <div class="dx-fieldset">
            <div class="dx-field">
                <div data-bind="dxSelectBox: { dataSource: items, displayExpr: 'displayName', value: popupModel.textRangeValue, placeholder: $root.getLocalization('Select Period', 'AnalyticsCoreStringId.Mobile_DateRange_SelectPeriod') }"></div>
            </div>
            <div class="dx-field">
                <div class="dx-fieldset-column">
                    <div class="dx-fieldset-header" data-bind="text: $root.getLocalization('From','AnalyticsCoreStringId.Mobile_DateRange_From')"></div>
                    <div data-bind="css: popupModel._dateButtonEditorClassName, dxButton: { text: startDate && popupModel.getStringDate(startDate) || $root.getLocalization('Start Date','AnalyticsCoreStringId.Mobile_DateRange_StartDate'), stylingMode: 'contained', onClick: popupModel.focusButton, focusStateEnabled: false, activeStateEnabled: false }"></div>
                    <div data-bind="css: popupModel._dateEditorClassName">
                        <!-- ko template: { name: 'dxrv-daterange-calendar', data: _createTemplateData(startDate, undefined) } -->
                        <!-- /ko -->
                    </div>                    
                </div>
                <div class="dx-fieldset-column dx-fieldset-column-right">
                    <div class="dx-fieldset-header" data-bind="text: $root.getLocalization('Until','AnalyticsCoreStringId.Mobile_DateRange_Until')"></div>
                    <div class="dxd-back-secondary dx-fieldset-column-separator"></div>
                    <div data-bind="css: popupModel._dateButtonEditorClassName, dxButton: { text: endDate && popupModel.getStringDate(endDate) || $root.getLocalization('End Date','AnalyticsCoreStringId.Mobile_DateRange_EndDate'), stylingMode: 'contained', type:'default', onClick: popupModel.focusButton, focusStateEnabled: false, activeStateEnabled: false }"></div>
                    <div data-bind="css: popupModel._dateEditorClassName">
                        <!-- ko template: { name: 'dxrv-daterange-calendar', data: _createTemplateData(endDate, startDate) } -->
                        <!-- /ko -->
                    </div>
                </div>
            </div>
...
<script type="text/html" id="dxrd-page-brick-mobile">
    ...
    <div class="dxrdp-search-wrapper" data-bind="styleunit:{ height: height }, dxrdSearchBar: $data">
        <div class="dxrd-mobile-search">
            <div class="dxrdp-taptosearch" data-bind="visible: !$data.editorVisible(), dxclick: function(s, e) { $data.focusEditor(e); }">
...
<script type="text/html" id="dxrd-menu-export-content">
    <div class="dxrd-menu-export-popover" data-bind="dxPopover: { width: '266px', height: '266px', visible: visible, target: '.dxrdp-mobile-action.dxrd-image-export-to', container: $root.getPopupContainer($element), }">
        <!-- ko foreach: items -->
...
<script type="text/html" id="dxrd-menu-parameters-content">
    <div class="dxrd-menu-parameters-popup" data-bind="dxPopup: { showTitle: false, width: function() {return window.innerWidth }, height: function() {return window.innerHeight }, visible: visible, container: $root.getPopupContainer($element), }">
...
<script type="text/html" id="dxrv-preview-parameters-mobile">
    <div class="dxrdp-parameters-mobile" data-bind="dxValidationGroup: {}, css: className">
        ...
        <div class="dxrdp-parameters-scroll" data-bind="dxScrollView: { showScrollbar: 'onHover', useNative: false, scrollByThumb: true, bounceEnabled: false }">
            <!-- ko template: { name: $data.contentTemplate, data: model }-->
            <!-- /ko -->
        </div>
...
<script type="text/html" id="dxrv-preview-parameters-mobile-content">
    <div class="dx-fieldset">
        <div data-bind="dxPropertyGrid: { target: ko.observable($data) }"></div>
    </div>
</script>

<script id="dxrv-range-parameter-mobile" type="text/html">
    <div data-bind="dxrvDateRangeEditor: {value: $data.value(), isMobile: true }"></div>
</script><script type="text/html" id="dxrdp-surface-mobile">
    <div class="dxrd-preview-wrapper dxrdp-fullscreen dxrd-preview-surface" data-bind="style: { pointerEvents: $data.documentId === null ? 'none' : '', touchEvents: $data.documentId === null ? 'none' : '' }, styleunit: { top: topOffset, height: previewWrapperSize().height, width: previewWrapperSize().width }, slide: $root.slideOptions, mobileZoom: { zoom: mobileZoom, zoomUpdating: zoomUpdating }, dxclick: function(s,e) { if(!$root.brickEventsDisabled()) { $data.showActions(s,e); } }">
...
<script type="text/html" id="dxrp-editing-field-container">
    <div class="dxrp-editing-field-container dx-accessibility-editing-field-item dx-accessibility-border-accented" data-bind="style: containerStyle(), zoom: zoom, css: { active: active(), readonly: field.readOnly() }">
...
<script type="text/html" id="dxrp-editing-field-datetime">
    <div style="width: 100%" class="dxrp-editing-field-datetime" data-bind="dxDateBox: $data.getOptions({ dropDownOptions: { container: $root.getPopupContainer($element), position: { at: 'left bottom', collision: 'flipfit flip', my: 'left top', boundary: $root.getPopupContainer($element), of: $element } } }), childStyle: { style: textStyle(), selector: '.dx-texteditor-input'}"></div>
</script>
...
<script type="text/html" id="dxrp-editing-field-image-editor">
    <div style="height: 100%; width: 100%;" data-bind="dxPictureEditor: $data.getPictureEditorOptions()"></div>
</script>
...
<script type="text/html" id="dxrp-editing-field-checkbox">
    <div class="dxrp-editing-field-check-container dx-accessibility-editing-field-item dx-accessibility-border-accented" data-bind="style: containerStyle(), zoom: zoom, click: onClick">
        <div class="dxrp-editing-field-check" tabindex="1" data-bind="style: checkStyle(), template: {name: $data.checkStateStyleIcon, if: !!ko.unwrap($data.checkStateStyleIcon)}"> </div>
    </div>
</script>
...
﻿<script type="text/html" id="dxrd-preview-export-options">
    ...
    <!-- ko if: model-->
    <div class="dxrd-right-panel-body" data-bind="dxScrollView: { showScrollbar: 'onHover', useNative: false, scrollByThumb: true, onInitialized: (e) => { e.component.option('useKeyboard', false); }  }">
        <div class="dx-fieldset" data-bind="accessibilityKeyboardHelper: $data.keyboardHelper">
            <div role="tablist" class="dxrd-right-panel-content dxrd-export-options-content" data-bind="dxPropertyGrid: { target: model }"></div>
        </div>
    </div>
    <!-- /ko -->
...
<script type="text/html" id="dxrd-preview-export-to">
    <div class="dxrd-preview-export-toolbar-item dxrd-toolbar-item" data-bind="visible: visible">
        <div role="menu" class="dx-accessibility-toolbar-item dx-accessibility-focus-border-accented" data-bind="attr: { 'aria-label': $root.getLocalization(text, $data.textId), 'aria-hidden': ko.unwrap($data.visible) ? 'false' : 'true', 'aria-disabled': $data.disabled() ? 'true' : 'false' }" >
            <div class="dxrd-preview-export-to dxd-button-back-color dxd-state-normal dxd-back-highlighted" data-bind="dxMenu: { disabled: $data.disabled(), items: items, cssClass: 'dxrdp-export-to-menu', onItemClick: clickAction, onSubmenuShowing: $data.eventHandlers.onSubmenuShowing($root.getPopupContainer($element), $element), onSubmenuShown: $data.eventHandlers.onSubmenuShown, onSubmenuHiding: $data.eventHandlers.onSubmenuHiding, tabIndex: '-1' }, attr: { title: $root.getLocalization(text, $data.textId) }">
                <div class="dxrd-preview-export-menu-item" data-options="dxTemplate: { name: 'item' }" data-bind="attr: { title: $root.getLocalization(text, $data.textId) }">
                    <!--ko if: $data.format -->
                    <div class="dxrd-preview-export-item-text" data-bind="text: $root.getLocalization($data.text, $data.textId)"></div>
                    <!-- /ko -->
...
<script type="text/html" id="dxrd-preview-page">
    <div role="tabpanel" class="dxrd-report-preview-content" style="position: relative; width: 100%; height: 100%" data-bind="dxclick: clickToBrick, 'brick-selection-prog': { page: $data, preview: $parent, click: function(pageIndex) { $parent.goToPage(pageIndex) } }">
        ...
        <div role="img"  data-bind="attr: {'aria-label': $parent.currentPageAriaLabelImgAlt}">
            ...
            <!--/ko-->
            <!-- ko if: !brickLoading() && $data.editingFields-->
            <div data-bind="accessibilityKeyboardHelper: editingFieldsKeyboardHelper">
                <!-- ko foreach: editingFields -->
                <!-- ko template: template -->
                <!--/ko-->
                <!--/ko-->
    ...
    <div class="dxrp-editing-field-container" data-bind="style: containerStyle() ">
        <div class="dx-accessibility-editing-field-item dx-accessibility-border-accented" data-bind="dxclick: activateEditor, css: parentPopupClass">
            <div class="dxrp-editing-field-popup-container-cloned" data-bind="dxPainter: $data.getPainter()"></div>
            <!-- ko template: { name: 'dx-picture-editing-popup', data: $data.getPopupData() } -->
            <!-- /ko -->
        </div>
    </div>
</script>
...
<script type="text/html" id="dx-picture-editing-popup">
    <div class="dx-picture-edit-popup-content dx-picture-edit-popup-content-fullscreen" data-bind="dxPopup: {
            width: contentData.containerStyle().width,
            height: contentData.containerStyle().height,
            position: { boundary: getContainer(), of: getPositionTarget($element) },
            ...
            onShown: onShown,
            shading: false,
            animation: { show: {}, hide: { type: 'fade', duration: 100, to: { opacity: 0 }, from: { opacity: 1 } }},
            visible: isVisible($element) }">
        <!-- ko if: showContent -->
        <!-- ko template: { name: contentTemplate, data: contentData, afterRender: $data.renderedHandler } -->
        <!--/ko-->
        <!--/ko-->
    </div>
</script><script type="text/html" id="dxrd-zoom-autofit-select-template">
        <div class="dxrd-toolbar-item-zoom" data-bind="visible: visible">
            <div role="combobox" class="dx-accessibility-toolbar-item dx-accessibility-focus-border-accented" data-bind="attr: { 'aria-label': $root.getLocalization('Zoom', 'ASPxReportsStringId.WebDocumentViewer_AriaLabelZoomCombobox'), 'aria-hidden': ko.unwrap($data.visible) ? 'false' : 'true', 'aria-disabled': $data.disabled() ? 'true' : 'false' }" >
                <div class="dxrd-toolbar-item-zoom-editor" data-bind="dxSelectBox: { items: zoomItems, value: $data.zoom, displayExpr: displayExpr, displayCustomValue: true, acceptCustomValue: true, onCustomItemCreating: onCustomItemCreating, dropDownOptions: { container: $root.getPopupContainer($element), position: { my: 'left top', at: 'left bottom', of: $element } }, tabIndex: '-1' }"></div>
            </div>
        </div>
</script>

<script type="text/html" id="dxrd-preview-toolbar-scrollable">
    <div class="dxrd-toolbar-wrapper dxrdp-toolbar-scrollable" data-bind="dxScrollView: { showScrollbar: 'onHover', direction: 'horizontal', useNative: false, scrollByThumb: true, onInitialized: (e) => { e.component.option('useKeyboard', false); }  }">
...
<script type="text/html" id="dxrd-preview-search">
    <div class="dxrd-preview-search-wrapper" data-bind="visible: active() && visible(), accessibilityKeyboardHelper: $data.keyboardHelper">
        <!-- ko with: model -->
        ...
        <div class="dxrd-preview-search-result-header dxd-border-primary">
            <div class="dx-accessibility-focus-border-accented dxrd-preview-search-result-header-text" data-bind="text: $root.getLocalization('Search result', 'ASPxReportsStringId.WebDocumentViewer_SearchResultText')"></div>
        </div>
        <div class="dx-accessibility-container-background dxd-back-accented"></div>            
        <div class="dxrd-preview-search-result dxd-border-accented" data-bind="dxList: { dataSource: searchResultDataSource, pageLoadMode: 'scrollBottom', focusStateEnabled:false, hoverStateEnabled:false, onItemRendered: onItemRendered, noDataText: '' }">
            <div class="dxrd-preview-search-result-item dxd-list-item-back-color dxd-back-highlighted dx-accessibility-list-item dx-accessibility-focus-border-accented" data-bind="dxAction: { model: $data, action: $parent.itemClickAction }" data-options="dxTemplate : { name: 'item' }">  
                <div class="dx-accessibility-field-background dxd-back-accented"></div>
                <div class="dxrd-preview-search-tab-item-text propertygrid-editor-displayName dxd-text-primary" data-bind="text: $data.data.text"></div>
                <div class="dxrd-preview-search-tab-item-info" data-bind="text: $root.dx._static.formatSearchResult($data.data)"></div>
            </div>  
        </div>
        <!-- /ko -->
    </div>
...
<script type="text/html" id="dxrd-preview-progress-bar">
    <div role="dialog" class="dxrd-preview-progress dxd-popup-back-color dxd-back-primary2 dxd-border-primary" data-bind="visible: visible, css: $data.cssClasses, accessibilityKeyboardHelper: progressBarAccessibility">
        ...
        <div role="button" class="dxrd-preview-progress-cancel dxd-hyperlink-color dxd-border-accented dxd-text-accented dx-accessibility-list-item dx-accessibility-border-accented" data-bind="text: cancelText, dxAction: { model: $data, action: function() { $data.stop && stop(); }}"></div>
    </div>
</script>
...
<script type="text/html" id="dxrd-preview-parameters">
    <div class="dxrd-preview-parameters-wrapper dxrd-preview-property-wrapper" data-bind="visible: active() && visible()">
        ...
        <!-- /ko -->
        <!-- ko if: (model && !model.isEmpty()) -->
        <div class="dxrd-right-panel-body" id="propertiesPanel" data-bind="dxScrollView: { showScrollbar: 'onHover', useNative: false, scrollByThumb: true, onInitialized: (e) => { e.component.option('useKeyboard', false); } }, dxValidationGroup: {}, accessibilityKeyboardHelper: $data.keyboardHelper">
            <div class="dx-fieldset">
                <!-- ko template: { name: 'dx-propertieseditor', data: $data.propertyGrid } -->
                <!-- /ko -->
            </div>
            <div class="dxrd-preview-parameter-actions-container">
                ...
                <div class="dxrd-preview-parameter-action dxrdp-parameters-reset dx-accessibility-focus-border-accented" data-bind="dxButton: { text: $root.getLocalization('Reset', 'ASPxReportsStringId.ParametersPanel_Reset'), onClick: function() { model.restore(); } }"></div>
                <div class="dxrd-preview-parameter-action dxrdp-parameters-submit dx-accessibility-focus-border-accented" data-bind="dxButton: { text: $root.getLocalization('Submit', 'ASPxReportsStringId.ParametersPanel_Submit'), onClick: function(params) { model.validateAndSubmit(params); } }"></div>
            </div>
        </div>
        <!-- /ko -->
    </div>
...
<script type="text/html" id="dxrd-preview-pager">
    <div class="dxrd-preview-pager dxrd-toolbar-item" data-bind="visible: visible">
        <div role="combobox" class="dx-accessibility-toolbar-item dx-accessibility-focus-border-accented" data-bind="attr: { 'aria-label': $root.getLocalization('Pager', 'ASPxReportsStringId.WebDocumentViewer_AriaLabelPagerCombobox') , 'aria-hidden': ko.unwrap($data.visible) ? 'false' : 'true', 'aria-disabled': $data.disabled() ? 'true' : 'false' }" >
            <div class="dxrd-preview-pager-selectbox" data-bind="dxSelectBox: { dataSource: pageItems, value: selectedItem, opened: opened, displayExpr: displayExpr, onFocusOut: focusOut, onKeyUp: keyUp, itemTemplate: itemTemplate, searchMode: searchMode, searchEnabled: searchEnabled, searchTimeout: searchTimeout, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) }, tabIndex: '-1' }"></div>
        </div>
        <div class="dxrd-toolbar-item-separator dxd-toolbar-separator-color dxd-border-secondary" data-bind="visible: $data.hasSeparator"></div>
    </div>
</script>
...
<div class="dxrd-preview-document-map" data-bind="visible: active() && visible()" style="height: 100%; overflow:hidden">
    ...
    <!-- ko if: model -->
    <!-- ko with: model -->
    <div class="dxrd-right-panel-body" data-bind="dxScrollView: { showScrollbar: 'onHover', useNative: false, scrollByThumb: true, onInitialized: (e) => { e.component.option('useKeyboard', false); } }, accessibilityKeyboardHelper: $parent.keyboardHelper">
        <div role="tree" id="documentMapTree" data-bind="treelist: documentMapOptions" style="width:100%; height: 100%;"></div>
    </div>
    <!-- /ko -->
    <!-- /ko -->
</div>
...
<script type="text/html" id="dxrdp-surface">
    <div class="dxrd-preview-wrapper" data-bind="textCopier, css: { 'dx-rtl': $data.rtlReport, 'dxrp-editing-fields-hightlighted': editingFieldsHighlighted } ">
        ...
        <!-- /ko -->
        <!-- /ko -->
        <div class="dxrd-preview-surface" data-bind="accessibilityKeyboardHelper: previewBrickKeyboardHelper">
            <!-- ko if: !showMultipagePreview() -->
            <div class="dxrd-report-preview-holder">
                <!-- ko with: currentPage-->
                <!-- ko if: pageLoading() || (!pageLoading() && displayImageSrc()) -->
                <div role="tab" class="dxrd-report-preview dx-accessibility-page-item dx-accessibility-border-accented" data-bind="styleunit: { width: width, height: height }, autoFit: { autoFitBy: $parent.autoFitBy, zoom: zoom, width: originalWidth, height: originalHeight, rightPanelWidth: $root.tabPanel.width, previewSize: $parent.previewSize, brickLoading: brickLoading } ">
                    <!-- ko template: { name: 'dxrd-preview-page', afterRender: function() { $parent.delayedInit() } }-->
                    <!-- /ko -->
                </div>
                <!-- /ko -->
                <!-- /ko -->
            ...
            <div class="dxrd-report-preview-holder" data-bind="lazyImages: { enabled: showMultipagePreview, updateCallback: onSizeChanged }">
                <!-- ko foreach: {data: pages, afterRender: function() { $parent.model.delayedInit() } }  -->
                <!-- ko lazy: { if: pageLoading() || (!pageLoading() && displayImageSrc()) } -->
                <div role="tab" class="dxrd-report-preview dxrd-report-preview-multipage dx-accessibility-page-item dx-accessibility-border-accented" data-bind="styleunit: { 'width': width(), 'height': height() }, toView: { active: active }, css : { 'dxrd-report-preview-active': active }">
    ...
    <div id="clipboard-container" style="position:absolute;top:-100px;"><textarea disabled id="clipboard"></textarea></div>
</script>﻿<script type="text/html" id="dxrv-daterange-editor">
    <div class="dxrv-daterange-editor">
        <div data-bind="cacheElement: { action: function(element) { $data._$element = element; } }, dxEllipsisEditor: { value: _displayText, readOnly:true, inputAttr: { 'aria-label': $parent.displayName }, openOnFieldClick: true, buttonAction: function() { $data._showPopup(); } }"></div>
...
<script type="text/html" id="dxrv-daterange-editor-popup">
    <div role="dialog" aria-modal="true" data-bind="dxPopup: {
                width: $root.calculateWithZoomFactor(800),
                height: $root.calculateWithZoomFactor(350),
                maxWidth: function() { return window.innerWidth - 1;},
                maxHeight: function() { return window.innerHeight - 1;},
                position: { my: 'right top', at: 'right bottom', of: $data._$element, collision: 'fit fit', offset: '1 -1' },
                container: $root.getPopupContainer($element),
                target: $root.getPopupContainer($element),
                showTitle: false,
                showCloseButton: false,
                closeOnOutsideClick: true,
                animation: {},
        ...
        <div data-bind="dxScrollView: { showScrollbar: 'always', direction: 'horizontal', useNative: false, onInitialized: (e) => { e.component.option('useKeyboard', false); } }">
            <div class="dxrv-daterange-editor-popup-container" data-bind="accessibilityKeyboardHelper: $data.dialogKeyboardHelper">
                <div role="listbox" class="dxrv-daterange-editor-list dxrv-daterange-editor-item dxd-border-primary dx-accessibility-daterange-item" data-bind="accessibilityKeyboardHelper: $data.dialogKeyboardHelper.predefinedDateRangesKeyboardHelper, dxScrollView: { showScrollbar: 'onHover', scrollByContent: false, bounceEnabled: false, useNative: false, scrollByThumb: true, onInitialized: (e) => { e.component.option('useKeyboard', false); } }">
                    <div class="dx-accessibility-container-background dxd-back-accented"></div>
                    <!-- ko foreach: items -->
                    <div role="option" class="dxrv-daterange-editor-list-item dxd-state-normal dxd-back-highlighted dx-accessibility-list-item dx-accessibility-focus-border-accented" data-bind="attr: { 'aria-selected': $parent._isSelected($data) }, css: { 'dxd-state-selected': $parent._isSelected($data) }, dxAction: { model: $data, action: function() { $parent.applyDate($data.range(), true) }}">
                        <div class="dx-accessibility-field-background dxd-back-accented"></div>
                        <!-- ko text: displayName -->
                        <!-- /ko -->
                    </div>
...
<script type="text/html" id="dxrv-daterange-calendar">
    <div tabIndex="0" class="dx-accessibility-calendar-item dx-accessibility-daterange-item" data-bind="dxCalendar: { value: value, cellTemplate: 'select_cell', height: '100%', min: min }">
...
<script id="dxrv-range-parameter" type="text/html">
    <div data-bind="dxrvDateRangeEditor: {value: $data.value() }"></div>
</script><script type="text/html" id="dxrd-multivalue">
    <!-- ko with: value -->
    <div data-bind="dxTagBox: $parent.getOptions({ dataSource: $data.dataSource, searchEnabled: true, searchExpr: $data.searchExpr || ['displayValue'], value: $data.value,
         displayExpr: $data.displayExpr || 'displayValue', valueExpr: $data.valueExpr || 'value', multiline: false, showSelectionControls: true,
         showDropDownButton: !!$data.showDropDownButton, selectAllMode: 'allPages', selectedItems: $data.selectedItems,
         inputAttr: { 'aria-label': $parent.displayName },
         placeholder: $root.dx._static.selectPlaceholder(), maxDisplayedTags: $data.maxDisplayedTags, dropDownOptions: { container: $root.getPopupContainer($element) } }), 
         dxValidator: { validationRules: $parent.validationRules || [] }">
    </div>
    <!-- /ko -->
</script>
...
﻿<script type="text/html" id="dx-picture-editing">
    <div class="dx-picture-editing">
        ...
        <div class="dx-picture-editing-active" data-bind="dxPopup: {
                ...
                position:{ my: 'left top', at: 'right top', boundary: '.dxrd-preview-surface', of: $data.$element, collision: 'fit fit', offset: '1 -1' },
            ...
            <div data-options="dxTemplate: { name: 'content' }">
                <div class="dx-picture-editing-toolbar" data-bind="foreach: $data.actions">
                    <div class="dx-picture-editing-toolbar-item" data-bind="dxclick: $data.action, attr: { title: title }">
...
<script type="text/html" id="dx-picture-editing-toolbar-popup">
    <div class="dx-picture-edit-popup-content" data-bind="dxPopover: {
            ...
            position: { my: 'left top', at: 'right top', boundary: '.dx-designer', of: getPositionTarget(), collision: 'flipfit fit', offset: '-10 0' },
        ...
        <div class="dx-picture-editing-line-color">
            ...
            <div class="dx-picture-editing-brush-options-colors" data-bind="foreach: $data.colors">
                <div class="dx-picture-editing-brush-options-color" data-bind="css: { selected: $data.isSelected }">
                    <div class="dx-picture-editing-brush-options-color-cell" data-bind="style: { background: $data.value }, dxclick: $data.action"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="dx-picture-editing-sizemode-alignment">
        <div class="dx-picture-editing-sizemode">
            ...
            <div class="dx-picture-editing-sizemode-values" data-bind="foreach: { data: sizeModeValues }">
                <div class="dx-picture-editing-sizemode-alignment-value" data-bind="css: { selected: isSelected }, template: $data.iconTemplate, dxclick: $data.action">
                </div>
            </div>
        </div>
...
<script type="text/html" id="dx-picture-editing-imagespicker">
    ...
    <div data-bind="dxSelectBox: getOptions({ dataSource: values, value: value, valueExpr: 'value', displayExpr: 'displayValue', displayCustomValue: true, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) }, inputAttr: { 'aria-label': displayName } }), dxValidator: { validationRules: $data.validationRules || [] }"></div>
</script>
...
﻿<script type="text/html" id="dxcd-collection-lookup-header">
    <div data-bind="dxSelectBox: { items: array, displayExpr: 'name', value: selectedItem, disabled: disabled,  placeholder: $root.dx._static.selectPlaceholder(), noDataText: $root.dx._static.noDataText(), dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>
...
<script type="text/html" id="dxcd-field">
    <!-- ko if: visible -->
    <div data-bind="dxFieldListPicker: { path: path, value: value, acceptCustomValue: true, itemsProvider: $root.dataBindingsProvider(), treeListController: treeListController, disabled: disabled }"></div>
    <!--/ko -->
</script>
...
<script type="text/html" id="dxcd-panes-editor">
    <div data-bind="dxSelectBox: { dataSource: $root.panes, value: value, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>

<script type="text/html" id="dxcd-legends-editor">
    <div data-bind="dxSelectBox: { dataSource: $root.legends, value: value, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>

<script type="text/html" id="dxcd-axisX-editor">
    <div data-bind="dxSelectBox: { dataSource: $root.axisX, value: value, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>

<script type="text/html" id="dxcd-axisY-editor">
    <div data-bind="dxSelectBox: { dataSource: $root.axisY, value: value, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>
...
<script type="text/html" id="dxcd-viewHeader">
    <div data-bind="dxSelectBox: { dataSource: generateViewItems(), itemTemplate: 'stateItem', valueExpr: 'value', value: generateHeaderValue($root.undoEngine), displayExpr: 'displayValue', disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }">
        <div class="lookupItem" data-options="dxTemplate:{ name:'stateItem' }">
            <div style="display:inline-block; width: 24px; height: 24px;" data-bind="css: className, template: {name: templateName, if: !!templateName }"> </div>
...
<script type="text/html" id="dxcd-summaryFunction-content">
    <div class="dxcd-summary-function-content">
        ...
        <div class="dx-field dxd-back-primary">
            ...
            <div class="dx-field-value">
                <div data-bind="dxSelectBox: { value: functionName, dataSource: $parent.availableItems() ,acceptCustomValue: true, disabled: $parent.disabled(), placeholder: $root.dx._static.selectPlaceholder(), dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
            </div>
        </div>
        <!-- ko foreach: args -->
        <div class="dx-field dxd-back-primary" data-bind="css: $parents[1].actionsAreAvailable() ? 'dxcd-summaryfunction-arg' : ''">
        ...
        <div class="dx-field dxd-back-primary">
            <div class="dx-field-label dxd-text-primary" style="width:auto" data-bind="styleunit: $parent.memberPadding">
...
<script type="text/html" id="dxcd-group">
    <div data-bind="dxSelectBox: { dataSource: $root.groups, value: value, acceptCustomValue:true, onFocusOut: function() { $root.applyGroup($data.value()); }, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>

<script type="text/html" id="dxcd-color-undo">
    <div data-bind="dxColorBox: { value: generateValue($root.undoEngine), editAlphaChannel: true, popupPosition: { collision: 'flipfit flipfit' }, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>

<script type="text/html" id="dx-selectbox-undo">
    <div data-bind="dxLocalizedSelectBox: { dataSource: values, value: generateValue($root.undoEngine), valueExpr: 'value', displayExpr: 'displayValue', displayCustomValue: true, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }, dxValidator: { validationRules: $data.validationRules || [] }"></div>
...
﻿<script type="text/html" id="dxrd-band-coordinate-grid">
    ...
    <div data-bind="styleunit: { 'height': height, top: absolutePosition.y }" class="dxrd-band-collapsed">
        <div data-bind="css: { 'dxrd-band-content-selected dxd-border-accented dx-border-inheritor': selected() }" style="position:absolute; height: 100%; width: 100%"></div>
    </div>
    <!-- /ko -->
    <!-- /ko -->
</script>
...
﻿<!-- ko with: surface -->
<div class="dxrd-band-marker-wrapper" data-bind="attr: { title: name }, styleunit: { 'width': $data.markerWidth() + 20, 'top': absolutePosition.y, 'height': height }" style="position:absolute">
    <!--  ko if: hasOwnRuler -->
...
﻿<script type="text/html" id="dxrd-band">
    <!-- ko ifnot: collapsed -->
    <div class="dxrd-band-content dxd-selectable" data-bind="styleunit: { 'height': heightWithoutSubBands, 'width': _width(), 'top': absolutePosition.y }" style="position:absolute;">
        <!-- ko if: $data._context.drawWatermark() -->
    ...
    <div class="dxrd-print-across-bands-placeholder" data-bind="visible: $data.isVisible, styleunit: { 'top': $data.absolutePositionY, 'height': $data.height }">
        <!-- ko with: $data.band -->
        <div class="dxrd-band-content dxd-selectable" data-bind="styleunit: { 'height': heightWithoutSubBands, 'width': _width() }" style="position:absolute;">
            <!-- ko foreach: controls -->
            <!-- ko template: { name: $data.template } -->
            <!-- /ko -->
            <!-- /ko -->
...
<script type="text/html" id="dxrd-band-collapsed">
    <!-- ko if: collapsed -->
    <div class="dxrd-band-collapsed dxd-selectable" data-bind="styleunit: { 'height': height, 'line-height': height, 'top': absolutePosition.y, width: rect().width }" style="position:absolute">
...
﻿<script type="text/html" id="dxrd-band-holder">
    ...
    <div data-bind="styleunit: { 'height': height, 'width': _width, left: absolutePosition.x }, resizable: { starting: function() { $root.resizeHandler.started = true; $root.resizeHandler.starting() }, stopped: function() { $data.stopResize(); $root.resizeHandler.stopped(); $root.resizeHandler.started = false;}, handles: resizeHandles(), disabled: !canResize(), forceResize: resize, zoom: $root.surface().zoom, minimumWidth: minimumWidth(), minimumHeight: minimumHeight() },  css: { 'dxrd-band-content-selected dxd-border-accented dx-border-inheritor': selected() }, trackCursor: underCursor" style="position:absolute">
        ...
        <div style="height: calc(100% - 29px); width: 100%; position: absolute">
            <!-- ko foreach: controls -->
            <!-- ko template: { name: $data.selectiontemplate } -->
            <!-- /ko -->
            <!-- /ko -->
...
﻿<script type="text/html" id="dxrd-vertical-bands-container">
    ...
    <div class="dxrd-band-content dxrd-vertical-bands-container" data-bind="styleunit: { 'height': height, left: leftOffset, 'width': width, top: topOffset },
        ...
        <div data-bind="styleunit: { 'width': width }" style="height: 100%; overflow:hidden;position: absolute;">
    ...
    <!-- /ko -->
    <!-- ko if: collapsed -->
    <div class="dxrd-band-collapsed" data-bind="styleunit: { 'height': height, 'line-height': height, 'top': topOffset, width: width }" style="position:absolute">
        <div style="position: absolute" data-bind="text: (name || '').toUpperCase(), styleunit: { 'right': $root.surface().rtl() ? leftMargin : 'auto', 'left': !$root.surface().rtl() ? leftMargin: 'auto' }"></div>
    </div>
    <!-- /ko -->
</script>
...
<script type="text/html" id="dxrd-vertical-bands-container-selection">
    <!-- ko ifnot: collapsed -->
    <div data-bind="styleunit: { 'width': width, top: topOffset, left: leftOffset, height: height() }" style="overflow:hidden;position: absolute;">
...
<script type="text/html" id="dxrd-vertical-bands-container-vruler">
    <!-- ko with: surface -->
    <div class="dxrd-band-marker-wrapper" data-bind="styleunit: { 'width': markerWidth() + 20, 'top': topOffset, 'height': height }" style="position:absolute">
...
<script type="text/html" id="dxrd-vertical-bands-leftMargin">
    ...
    <!-- /ko -->
</script><script type='text/html' id='dxrd-barcode-content'>
...
﻿<div data-bind="style: { cssFloat: isGlyphAlignmentNear() ? 'left': 'right', width: checkStateWidthContainer() }, styleunit: { lineHeight: contentHeightWithoutZoom }" style="text-align:center ">
...
<div style="display: inline-block; box-sizing: border-box; letter-spacing: normal; padding-left:3px" data-bind="styleunit: { width: textWidth, lineHeight: contentHeightWithoutZoom }, visible: visibleText, style: { cssFloat: isGlyphAlignmentNear() ? 'right': 'left' }">
...
﻿<div style="box-sizing: border-box; letter-spacing: normal; width:100%" data-bind="styleunit: { lineHeight: contentHeightWithoutZoom }">
...
﻿<div class="dxrd-control" data-bind="style: { visibility: (selected() || focused()) ? 'inherit' : 'hidden'}, css: {'dxrd-selected': selected, 'dxrd-focused': focused, 'dxrd-intersect': isIntersect, 'dxrd-locked': locked }, resizable: $data.getResizableOptions($root.resizeHandler), draggable: $root.dragHandler, styleunit: position, trackCursor: underCursor">
    <div class="dxd-border-accented dxrd-control-border-box"></div>
</div>
<div class="dxrd-control" data-bind="visible: !(selected() && focused()), styleunit: position, trackCursor: underCursor, style:{ overflow: isSelected() ? 'visible' : 'hidden'}">
    <div class="dxrd-control-content-select-main" data-bind="styleunit: { 'top': contentSizes().top + (isIntersect() ? 1 : 0), 'left': contentSizes().left + (isIntersect()? 1 : 0), lineHeight: contentSizes().height, height: contentSizes().height, width: contentSizes().width}">
...
<div data-bind="visible: !$data.showSkeleton()">
    <div data-bind="styleunit: { lineHeight: contentHeightWithoutZoom }, visible: $data.visibleImage" style="text-align:center;">
...
﻿<div class="dxrd-control" data-bind="visible: selected() || focused(), css: {'dxrd-selected': selected, 'dxrd-focused': focused, 'dxrd-intersect': isIntersect, 'dxrd-locked': locked }, resizable: $data.getResizeOptions($root.resizeHandler), draggable: $root.dragHandler, styleunit: position, trackCursor: underCursor">
    <div class="dxd-border-accented dxrd-control-border-box"></div>
</div>
<div class="dxrd-control" data-bind="visible: !(selected() && focused()), styleunit: position, trackCursor: underCursor, style:{ overflow: isSelected() ? 'visible' : 'hidden'}">
    <div class="dxrd-control-content-select-main" data-bind="styleunit: { 'top': contentSizes().top + (isIntersect() ? 1 : 0), 'left': contentSizes().left + (isIntersect()? 1 : 0), lineHeight: contentSizes().height, height: contentSizes().height, width: contentSizes().width}">
...
﻿<div style="box-sizing: border-box; letter-spacing: normal; width:100%; height:100%" data-bind="styleunit: { lineHeight: contentHeightWithoutZoom }">
...
﻿<div class="dxrd-surface" data-bind="styleunit: { 'width': Math.min($data.pageWidth() + $data.maxMarkerWidth() + $root.verticalScrollOffset() , $root.surfaceSize()) }, css: { 'dxrd-surface-rtl': rtl() }, click: function(surface, e) { !$root.selection.disabled() && $root.selection.clickHandler($root.selection.dropTarget ? null : surface, e); e.stopPropagation(); }, keyDownActions: $root.actionLists">
                        ...
                        <div class="dxrd-ghost-container" data-bind="styleunit: { 'width': pageWidthWithoutMargins, 'height': minHeight }">
                            ...
                            <div class="dxrd-bands-content dxrd-selection" data-bind="styleunit: { 'width': pageWidthWithoutMargins }">
                                <div class="dxrd-bands-content-offset">
                                    <div class="dxrd-leftMargin-resizable" data-bind="styleunit: { 'width': pageWidthWithoutMargins, 'left': leftMarginResizableOffset }, resizable: leftMarginResizeOptions($root.undoEngine, $element)"></div>
                                    <!-- ko template: { name: 'dxrd-band-holder', data: { templateName: 'selectionTemplate', holder: $data.bandsHolder, getData: function(item) { return item; } } }-->
                                    <!-- /ko -->
                                    <!-- ko foreach: crossBandControls -->
                                    <!-- ko if: visible -->
                                    <div class="dxrd-cross-band" data-bind="visible: isSelected() && !$root.dx._static.DragDropHandler.started(), css: {'dxrd-selected': selected, 'dxrd-focused': focused, 'dxrd-intersect': isIntersect, 'dxrd-locked': locked }, resizable: $root.resizeHandler, draggable: $root.dragHandler, styleunit: position, trackCursor: underCursor">
                                    </div>
                                    <!-- /ko -->
                                    <!-- /ko -->
...
﻿<div class="dxrd-control dxd-selectable" data-bind="styleunit: position, css: adorntemplate">
    <div class="dxrd-control-content-main" data-bind="styleunit: { 'top': contentSizes().top, 'left': contentSizes().left, lineHeight: contentSizes().height, height: contentSizes().height, width: contentSizes().width }, style: css">
        <div data-bind="zoom: _context.zoom, template: contenttemplate, styleunit: { height: contentHeightWithoutZoom, width: contentWidthWithoutZoom }" style="position:absolute;">
        </div>
    </div>
    <div data-bind="style: borderCss" style="width:100%; height: 100%; position:absolute; box-sizing:border-box"></div>
</div>
...
﻿<div class="dxrd-control dxd-selectable" data-bind="styleunit: position, css: adorntemplate">
    <div class="dxrd-control-content-main" data-bind="styleunit: { 'top': contentSizes().top, 'left': contentSizes().left, lineHeight: contentSizes().height, height: contentSizes().height, width: contentSizes().width }, style: css">
        <div data-bind="zoom: _context.zoom, template: contenttemplate, styleunit: { 'lineHeight': contentHeightWithoutZoom }" style="position:absolute;">
        </div>
    </div>
    <div data-bind="style: borderCss" style="width:100%; height: 100%; position:absolute; box-sizing:border-box"></div>
</div>
...
﻿<div class="dxrd-table-control" data-bind="style: { visibility: !isSelected() ? 'visible' : 'hidden'}, styleunit: position">
    <!-- ko if: rows().length > 0 -->
    <!-- ko foreach: rows -->
...
<div class="dxrd-table-control" data-bind="style: { visibility: (selected() || focused()) ? 'inherit' : 'hidden'}, css: { 'dxrd-selected': selected, 'dxrd-focused': focused, 'dxrd-intersect': isIntersect, 'dxrd-locked': locked }, resizable: $root.resizeHandler, draggable: $root.dragHandler, styleunit: position">
    <div class="dxd-border-accented dxrd-control-border-box"></div>
    <!-- ko if: rows().length > 0 -->
    ...
    <div class="dxrd-table-row-control" data-bind="styleunit: { 'top': position.top, 'height': position.height }">
        ...
        <!-- /ko -->
        <div class="dxrd-table-row-selection dxrd-table-row-selection-right" style="visibility: visible" data-bind="trackCursor: underCursor, visible: !$root.dx._static.DragDropHandler.started()"></div>
    </div>
    <!-- /ko -->
...
﻿<div class="dxrd-control dxd-selectable" data-bind="styleunit: position, trackCursor: underCursor, style: css, css: adorntemplate">
    ...
    <div data-bind="css: controlTypeClass, template: controlTypeIconTemplate" style="position: absolute; width: 24px; height: 24px; right: 5px; top: 5px;"> </div>
...
﻿<script type="text/html" id="dxrd-expressions-tab">
    <div class="dxrd-properties-wrapper dxrd-expressions-tab" data-bind="visible: active() && visible()">
        <div style="height:100%">
            ...
            <!-- /ko -->
            <div class="dxrd-properties-grid dxd-border-primary" data-bind="dxScrollView: { showScrollbar: 'onHover', useNative: false, scrollByThumb: true }" style="top: 80px">
...
﻿<div class="dxrd-fieldslist-wrapper" data-bind="visible: active() && visible()" style="height: 100%; overflow:hidden">
    ...
    <div class="dxrd-right-panel-header dxd-text-primary">
        ...
        <div id="btn-add-dataSource" class="dxrd-collectioneditor-action" style="line-height: 20px; margin-top: 8px" data-bind="dxButtonWithTemplate: { onClick: showPopover, icon: 'dxrd-svg-operations-add_datasource', iconClass: 'dxrd-image-add-datasource', visible: addDataSourceBtnVisible }, attr: { title: $root.getLocalization('Add Data Source', 'ReportStringId.UD_Title_FieldList_AddNewDataSourceText') }">
        </div>
        <div class="dxrd-add-dataSource-popup-content" data-bind="dxPopover:{ width: 200, visible: popoverVisible, target: '#btn-add-dataSource', container: $root.getPopupContainer($element), title:$root.getLocalization('Add Data Source', 'ReportStringId.UD_Title_FieldList_AddNewDataSourceText') + ':' }">
    ...
    <div class="dxrd-localization-editor dx-editors" data-bind="css: { 'dx-rtl': $root.rtl, 'dx-ltr': !$root.rtl }, styleunit: { width: width }">
        <div class="dxrd-left-localization-panel dx-editors dxd-text-primary dxd-back-primary" data-bind="resizable: getResizableOptions($element, 0, 500, $root.rtl ? 'Left': 'Right', 'Right', width)">
            <div class="dxrd-localization-panel-header dxd-back-primary2 dxd-border-secondary">
                ...
                <div class="dx-fieldset">
                    <div class="dx-field">
                        <div class="dxrd-localization-language" data-bind="css: { 'dx-property-gread-search-uncollapsed ': isSearching() }">
                            ...
                            <div class="dx-field-value" data-bind="css: { 'dx-field-value-shortened': getRegisteredService() }">
                                <!-- ko template: { name: 'dxrd-datasource-combobox', data: { getValues: function() { return $data.availableCultures; }, value: language, disabled: false } } -->
                                <!-- /ko -->
                            </div>
                            <!-- ko if: getRegisteredService() -->
                            <div class="dxrd-localization-panel-button" data-bind="dxButtonWithTemplate: { onClick: () => $data.applyLocalization($data.getRegisteredService()), 
                            ...
                            <!-- /ko -->
                            <div class="dxrd-localization-panel-button" data-bind="dxButtonWithTemplate: { onClick: clearLocalization, 
            ...
            <div class="dxrd-localization-panel-content">
                ...
                <div data-bind="dxList: { dataSource: localizationItems, selectionMode: 'single', height: 'calc(100% - 59px)', onSelectionChanged: onSelectionChanged, focusStateEnabled: false, activeStateEnabled: false, pageLoadMode: 'scrollBottom', noDataText: $root.dx._static.noDataText() }">
...
<!-- ko if: $data.reportSurface.watermark.shouldDrawWatermarkImage() -->
...
<!-- /ko -->
<!-- ko if: $data.reportSurface.watermark.text() -->
...
<script type="text/html" id="dxrd-scripting-controlchooser">
    <div class="dxrd-toolbar-item dxrd-toolbar-selectbox">
        <div data-bind="dxSelectBox: { dataSource: controls, value: control, displayExpr: displayExpr, placeholder: $root.getLocalization('Select control...', 'ASPxReportsStringId.ReportDesigner_ScriptEditor_Toolbar_SelectControl'), width: '300px', dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
        <div class="dxrd-toolbar-item-separator dxd-toolbar-separator-color dxd-border-secondary" data-bind="visible: $data.hasSeparator"></div>
    </div>
</script>
...
<script type="text/html" id="dxrd-scripting-eventchooser">
    <div class="dxrd-toolbar-item dxrd-toolbar-selectbox">
        <div data-bind="dxSelectBox: { items: events, value: event, placeholder: $root.getLocalization('Select event...', 'ASPxReportsStringId.ReportDesigner_ScriptEditor_Toolbar_SelectEvent'), width: '200px', dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
        <div class="dxrd-toolbar-item-separator dxd-toolbar-separator-color dxd-border-secondary" data-bind="visible: $data.hasSeparator"></div>
    </div>
...
<script type="text/html" id="dxrd-navigation-panel-template-content">
    ...
    <div class="dxrd-reportdialog dxrd-parameters-dialog dx-editors dx-widget" data-bind="css: popupCss, dxPopup: {
            showTitle: true,
            width: width,
            height: height,
...
<script type="text/html" id="dxrd-parameter-edit">
    <div class="dxrd-parameter-edit-content">
        <div data-bind="dxScrollView: { showScrollbar: 'onHover', height: 411 }">
...
<script type="text/html" id="dxrd-parameters-content">
    <div class="dxrd-parameters-content">
        <div class="dxrd-parameters-content-list dxd-border-primary" data-bind="dxCollectionEditor: _parametersListOptions">
        </div>
...
<script type="text/html" id="dxrd-parameters-checkbox">
    <div class="dx-field dxrd-parameters-checkbox">
        <div class="dx-field-value">
            <div class="propertygrid-editor-checkbox" data-bind="dxCheckBox: getOptions({ value: value, text: displayName, disabled: disabled }), dxValidator: { validationRules: validationRules || [] }"></div>
        </div>
    </div>
</script>
...
<script type="text/html" id="dxrd-multivalue-editing">
    ...
    <div class="dxrd-editor dxrd-parameter-group-editor">
        <div class="dxrd-parameter-values-collectioneditor" data-bind="dxCollectionEditor: {
            ...
            <div data-bind="dxPropertyGrid: { target: value, level: editor.level }"></div>
        </div>
    </div>
    <!-- /ko -->
</script>
...
<script type="text/html" id="dxrd-lookUpValues-editing">
    <div class="dxrd-editor dxrd-parameter-group-editor dxrd-parameters-group-offset" data-bind="visible: visible">
        <div class="dxrd-lookup-values-collectioneditor" data-bind="dxCollectionEditor: {
            ...
            <div data-bind="dxPropertyGrid: { target: $data.value, level: editor.level }"></div>
        </div>
    </div>
...
<script id="dxrd-openreport-dialog-content" type="text/html">
    ...
    <div class="dxrd-menubutton-part" tabindex="1" style="outline:inherit" data-bind="cacheElement: { action: function(element){ $data.setMenuElement(element) } }">
        <div class="dxrd-menu-container dxrd-menu-fullscreen-nav" data-bind="css: { 'dxrd-menu-fullscreen-nav-collapsed': isMenuCollapsed()}">
            <div class="dx-overlay-wrapper dxd-menu-back-color dxd-back-contrast" style="z-index:1002" data-bind="styleunit: { width: $data.isMenuCollapsed() ? 50 : 300 }, visible: appMenuVisible">
                <div class="dx-overlay-content">
                    ...
                    <!-- ko foreach: actionLists.menuItems -->
                    <div class="dxrd-menu-item dxd-text-primary dxd-list-item-back-color dxd-back-highlighted" data-bind="dxclick: function(e) { if(disabled && !disabled() || !disabled) { $root.toggleAppMenu(); clickAction($root.model(), e); }}, css: { 'dxrd-disabled-button': disabled, 'dxd-state-active': $data.selected }, visible: visible">
                        <div class="dxrd-menu-item-image" data-bind="css: ko.unwrap($data.imageClassName), template: {name: ko.unwrap($data.imageTemplateName), if: !!ko.unwrap($data.imageTemplateName)}, attr: { title: $data.displayText && $data.displayText() || text }"> </div>
...
<script type="text/html" id="dxrd-drag-helper-source-reportexplorer">
    <div class="dxrd-drag-helper-source-reportexplorer dxd-back-primary dxd-text-primary dxd-ghost-border-color dxd-border-accented">
...
<script type="text/html" id="dxrd-wizard-report-tree">
    <div class="dxrd-wizard-report-tree">
        ...
        <div class="dxrd-wizard-report-tree-selectbox" data-bind="dxSelectBox: { dataSource: $data.items, itemTemplate: 'stateItem', valueExpr: 'path', displayExpr: 'name', value: $data.value, dropDownOptions: { container: $root.getPopupContainer($element) } }">
...
<script type="text/html" id="dxrd-reportSourceUrl">
    <div data-bind="dxSelectBox: { dataSource: $data.getValues($root.reportUrls, $root.navigateByReports.currentTab), onOpened: function() { $data.updateUrls(); }, searchEnabled: true, value: value, disabled: disabled, valueExpr: 'Key', displayExpr: 'Value', dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>

<script type="text/html" id="dxrd-content-type">
    <!-- ko if: value -->
    <!-- ko with: value -->
    <div data-bind="dxLocalizedSelectBox: { items: $parent.values, value: type, valueExpr: 'value', displayExpr: 'displayValue', displayCustomValue: true, disabled: $parent.disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
    <!-- /ko -->
    <!-- /ko -->
</script>
...
<script type="text/html" id="dxrd-bands">
    <div data-bind="dxSelectBox: { items: generateValue($root.bands), value: value, displayExpr: 'displayName', valueExpr: 'value', displayCustomValue: true, disabled: disabled, placeholder: $root.getLocalization('(none)', 'ChartStringId.WizNoBackImage'), dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>
        ...
        <div data-bind="dxCollectionEditor: options">
            <div data-bind="dxdAccordion: { collapsed: collapsed }">
                <div class="dxrd-group-header dx-accordion-header dxd-text-primary">
                    <div class="dxrd-formatting-rule-checkbox" data-bind="dxCheckBox: { value: value().selected, disabled: editor.disabled }, dxclick: function(_, event) { event.stopPropagation(); }"></div>
                ...
                <div class="dx-accordion-content dxd-back-primary">
                    <div data-bind="dxPropertyGrid: { target: value, editorsInfo: { editors: $root.dx._static.formattingRuleSerializationsInfo }, level: editor.level + 1, parentDisabled: editor.disabled }"></div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/html" id="dxrd-fields-combobox">
    <div data-bind="dxSelectBox: { dataSource: wrapValues($root.displayNameProvider), value: value, valueExpr: 'value', displayExpr: 'displayValue', displayCustomValue: true, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element) } }, dxValidator: { validationRules: $data.validationRules || [] }"></div>
</script>

<script type="text/html" id="dxrd-style">
    <div data-bind="dxSelectBox: new $root.dx._static.StylesEditorHeaderModel(value, $root.styles(), disabled, $root.getPopupContainer($element))"></div>
</script>
...
<script type="text/html" id="dxrd-reportexplorer-editor">
    <div data-bind="dxFieldListPicker: { acceptCustomValue: true, value: itemsProvider.selectedPath, displayValue: displayExpr, itemsProvider: itemsProvider, path: itemsProvider.path, disabled: disabled, treeListController: treeListController }"></div>
</script>
...
<script type="text/html" id="dxrd-scriptsbox">
    <div data-bind="dxEventDropDownEditor: { items: $root.events, value: value, editEnabled: true, disabled: disabled, secondAction: function() { $root.gotoEvent && $root.gotoEvent($data.value(), name, $parents[1]._model && $parents[1]._model()); }, placeholder: $root.dx._static.selectPlaceholder(), noDataText: $root.dx._static.noDataText(), dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
</script>

<script type="text/html" id="dxrd-collection-item-group">
    <div class="dx-field dxd-back-primary" data-bind="styleunit: { 'marginLeft' : $parents[1].padding }">
        <div class="dx-field-label dxd-text-primary">
            <div class="propertygrid-editor-displayName" data-bind="text: $parents[1].options.info().getChildCaption(index()) + ':'"></div>
        </div>
        <div class="dx-field-value">
            <div class="dxrd-collectioneditor-action" data-bind="dxButtonWithTemplate: { onClick: value().changeSortOrder, icon: value().sortOrderClass().template, iconClass: value().sortOrderClass().class, disabled: editor.disabled }"></div>
...
<script type="text/html" id="dxrd-parameters">
    <div class="dxrd-editor" data-bind="visible: visible">
        <div data-bind="dxCollectionEditor: { values: value, displayName: displayName, level: level, info: info, addHandler: function() { return $root.parameters().add(); } }">
        </div>
    </div>
</script>
...
<script type="text/html" id="dxrd-collectionItemWithAccordion">
    <div class="dxrd-accordion-collection-item" data-bind="dxdAccordion: { collapsed: collapsed }">
        <div class="dxrd-group-header dx-accordion-header dxd-text-primary">
            <div data-bind="styleunit: {'paddingLeft': $parents[1].padding + $root.dx._static.propertiesGridEditorsPaddingLeft }">
                <div class="propertygrid-editor-collapsed dx-collapsing-image" data-bind="template: 'dxrd-svg-collapsed', css: { 'dx-image-expanded': !collapsed() }"></div>
                <div class="dx-group-header-font dxd-text-primary" data-bind="text: $root.getLocalization($parent.name), attr: { title: $root.getLocalization($parent.name) }"></div>
            </div>
        </div>
        <div class="dx-accordion-content dxd-back-primary">
...
<script type="text/html" id="dxrd-reportexpression-popup">
    <!-- ko if: $data.patchOptions($root.reportExplorerProvider) -->
    <div data-bind="dxExpressionEditor: { options: value, fieldListProvider: $root.reportItemsProvider, displayNameProvider: $root.expressionDisplayNameProvider && $root.expressionDisplayNameProvider(), editorTemplateName: 'dx-expressioneditor-popup', popupVisible: $data.popupVisible }"></div>
    <!-- /ko -->
</script>
...
<script type="text/html" id="dxrd-image-loadfile">
    <div data-bind="dxImageSourceEditor: { value: value, accept: 'image/*', type: 'img', disabled: disabled }"></div>
</script>

<script type="text/html" id="dxrd-pdfcontent-loadfile">
    <div data-bind="dxFileImagePicker: { value: value, placeholderId: 'File', disabled: disabled, accept:'.pdf' }"></div>
</script>

<script type="text/html" id="dxrd-summaryeditor-header">
    <!-- ko template: 'dx-emptyHeader' -->
    <!-- /ko -->
    <div class="dxrd-summaryeditor-popup" data-bind="dxPopup: {
            showTitle: true,
            width: '550px',
            height: '400px',
...
<script type="text/html" id="dxrd-datasource-combobox">
    <div data-bind="dxSelectBox: { dataSource: $data.getValues(), searchEnabled: true, value: value, valueExpr: 'value', displayExpr: 'displayValue', disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element)  }, popupPosition: { boundary: $root.getPopupContainer($element) } }">
...
﻿<div class="dxrd-wizard-page dxrd-wizard-columns-page">
    ...
    <div class="dxrd-wizard-splitter">
        <div class="dxrd-wizard-splitter-action" data-bind="dxButtonWithTemplate: { onClick: select, disabled: !isSelectEnable(), icon: 'dxrd-svg-operations-moveright', iconClass: 'dxrd-image-moveright' }" style="margin-top: 40px"></div>
        ...
        <div class="dxrd-wizard-splitter-action" data-bind="dxButtonWithTemplate: { onClick: unselect, disabled: !isUnselectEnable(), icon: 'dxrd-svg-operations-moveleft', iconClass: 'dxrd-image-moveleft' }" style="margin-top: 44px"></div>
        ...
        <div class="dxrd-wizard-customizelabel-list">
            <div class="dxrd-wizard-customizelabel-head-props">
                <div class="dxrd-wizard-customizelabel-select-papersize">
                    ...
                    <div data-bind="dxSelectBox: { items: _labelData.paperKinds, displayExpr: 'name', value: _selectedPaperSize, itemTemplate: 'PaperSizeText', dropDownOptions: { container: $root.getPopupContainer($element) }, 
                            onOpened: function (e) {
...
﻿<div class="dxrd-wizard-page dxrd-wizard-groups-page">
    <div class="dxrd-wizard-left-panel">
        ...
        <div class="dx-default-border-style dxd-border-secondary">
            <div class="dxrd-wizard-list" data-bind="dxList: { dataSource: fields.items, selectedItems: fields.activeItemArray, height: 257, selectionMode: 'single', activeStateEnabled: false, onItemClick: fieldClick, noDataText: $root.dx._static.noDataText() }">
    ...
    <div class="dxrd-wizard-splitter">
        ...
        <div class="dxrd-wizard-splitter-action" style="margin-top: 95px;" data-bind="dxButtonWithTemplate: { onClick: moveUp, disabled: !isMoveUpEnabled(), icon: 'dxrd-svg-operations-moveup', iconClass: 'dxrd-image-moveup' }"></div>
    ...
    <div class="dxrd-wizard-right-panel">
        ...
        <div class="dx-default-border-style dxd-border-secondary">
            <div class="dxrd-wizard-list" data-bind="dxList: { items: groups.items, height: 257, selectionMode: 'single', selectedItems: groups.activeItemArray, activeStateEnabled: false, onItemClick: groupClick, noDataText: $root.dx._static.noDataText() }">
    ...
    <div class="dxrd-wizard-page dxrd-wizard-masterdetail-groups-page dxd-border-secondary">
        <div class="dxrd-wizard-masterdetail-groups-page-section-content" data-bind="dxScrollView: { showScrollbar: 'onHover', height: '100%' }">
            <div class="dx-fieldset" data-bind="foreach: _groupInfos">
                ...
                <div class="dxrd-wizard-groups-item dx-field">
                    <div class="dx-field-label dxd-text-primary" style="width:auto">
    ...
    <div class="dxrd-wizard-masterdetail-groups-page-content">
        <div class="dxrd-wizard-left-panel">
            ...
            <div class="dx-default-border-style dxd-border-secondary dxrd-wizard-panel-content">
                ...
                <div class="dxrd-wizard-list" data-bind="dxList: { items: _currentFields().items, selectedItems: _currentFields().activeItemArray, height: '100%', selectionMode: 'single', activeStateEnabled: false, onItemClick: _fieldClick, noDataText: $root.dx._static.noDataText() }">
        ...
        <div class="dxrd-wizard-splitter">
            ...
            <div class="dxrd-wizard-splitter-action" style="margin-top: 83px;" data-bind="dxButtonWithTemplate: { onClick: _moveUp, disabled: !_isMoveUpEnabled(), icon: 'dxrd-svg-operations-moveup', iconClass: 'dxrd-image-moveup' }"></div>
        ...
        <div class="dxrd-wizard-right-panel">
            ...
            <div class="dx-default-border-style dxd-border-secondary dxrd-wizard-panel-content">
                ...
                <div class="dxrd-wizard-list" data-bind="dxList: { items: _currentGroups().items, height: '100%', selectionMode: 'single', selectedItems: _currentGroups().activeItemArray, activeStateEnabled: false, onItemClick: _groupClick, noDataText: $root.dx._static.noDataText() }">
...
<script id="dxrd-page-masterdetail-select-reportdata-dataMembers" type="text/html">
    <div class="dxrd-wizard-reportdata-column dx-first-column">
        ...
        <div class="dxrd-wizard-add-queries-page dxrd-wizard-masterdetail-dataMember dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover', height: 'auto' }">
            <div data-bind="treelist: _dataMemberFieldListModel" style="width:100%; height: 100%;"></div>
        </div>
    </div>
</script>
...
<script id="dxrd-page-masterdetail-select-reportdata-fieldMembers" type="text/html">
    <div class="dxrd-wizard-reportdata-column">
        ...
        <div class="dxrd-wizard-add-queries-page dxrd-wizard-masterdetail-fields dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover', height: 'auto' }">
            <div data-bind="treelist: _fieldMemberFieldListModel" style="width:100%; height: 100%;"></div>
        </div>
    </div>
</script>
        ...
        <div class="dxrd-wizard-masterdetail-summary-options-content">
            <div class="dxrd-wizard-list-container">
                <div class="dxrd-wizard-list dx-default-border-style dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover', height: '100%' }">
                    <div class="dxrd-wizard-summary-infos dxrd-wizard-summary-infos-paragraf dxd-border-secondary">
                        <div class="dxrd-wizard-summary-infos-fields dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary" data-bind="text: _fieldsCaption, attr:{'title': _fieldsCaption }"></div>
                        <div class="dxrd-wizard-summary-infos-summaries dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary" data-bind="text: _summaryFunctionCaption, attr:{'title': _summaryFunctionCaption }"></div>
                        <div class="dxrd-wizard-summary-infos-removebtn dxd-wizard-title-back-color dxd-back-secondary"></div>
                    </div>
                    <div data-bind="foreach: _summaryInfos">
                        <div class="dxrd-wizard-summary-infos dxd-border-secondary">
                            <div class="dxrd-wizard-summary-infos-fields dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary">
                                <div data-bind="dxFieldListPicker: {
                            ...
                            <div class="dxrd-wizard-summary-infos-summaries dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary">
                                <!-- ko template: { name: "dxrd-multivalue", data: $data } -->
                                <!--/ko-->
                            </div>
                            <div class="dxrd-wizard-summary-infos-removebtn dxd-wizard-title-back-color dxd-back-secondary">
...
﻿<div class="dxrd-wizard-page dxrd-wizard-masterdetail-summary-options-page">
    ...
    <div class="dxrd-wizard-masterdetail-summary-options-content">
        ...
        <div class="dxrd-wizard-list-container">
            <div class="dxrd-wizard-list dx-default-border-style dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover', height: '100%' }">
                <div class="dxrd-wizard-summary-infos dxrd-wizard-summary-infos-paragraf dxd-border-secondary">
                    <div class="dxrd-wizard-summary-infos-fields dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary" data-bind="text: _fieldsCaption"></div>
                    <div class="dxrd-wizard-summary-infos-summaries dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary" data-bind="text: _summaryFunctionCaption"></div>
                    <div class="dxrd-wizard-summary-infos-removebtn dxd-wizard-title-back-color dxd-back-secondary"></div>
                </div>
                <div data-bind="foreach: _summaryInfos">
                    <div class="dxrd-wizard-summary-infos dxd-border-secondary">
                        <div class="dxrd-wizard-summary-infos-fields dxd-wizard-title-back-color dxd-back-secondary dxd-border-secondary">
                            <div data-bind="dxSelectBox: { dataSource: $parent._displayedFields[$parent._currentPath()], itemTemplate: 'visibleItems', displayExpr: 'displayName', value: field, placeholder: $root.dx._static.selectPlaceholder(), dropDownOptions: { container: $root.getPopupContainer($element) } }">
...
<script type="text/html" id="dxrd-page-setup-page-preview">
    <div class="dxrd-wizard-preview dxd-back-secondary">
        ...
        <div style="width:100%; height:100%; position:relative" data-bind="cacheElement: { action: function(element) { $data.cachePagePreviewElement(element); } }">
...
<script type="text/html" id="dxrd-page-setup-groups">
    <div class="dxrd-page-setup-group">
        ...
        <div class="dx-fieldset dxrd-page-setup-long-group">
            <div class="dx-field">
                ...
                <div class="dx-field-value" data-bind="dxSelectBox: { items: lookupData.paperKind, valueExpr: 'value', displayExpr: 'displayName', value: paperKind, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
            </div>
        </div>
        <div class="dxrd-page-setup-setting">
            <div class="dx-fieldset dxrd-group-fieldset dxrd-page-setup-short-group">
                <div class="dx-field">
                    ...
                    <div class="dx-field-value" data-bind="dxSelectBox: { items: lookupData.unit, valueExpr: 'value', displayExpr: 'displayName', value: unit, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
                </div>
            ...
            <div class="dxrd-group-fieldset dxrd-page-setup-pagemode">
                <div class="dxrd-page-setup-landscape-item dxd-back-primary dxd-state-normal dxd-back-highlighted" style="margin-left: 0px" data-bind="css: { 'dxd-state-no-hover dxd-state-active': !$data.landscape() }, click: function() { $data.landscape(false); }">
    ...
    <div class="dxrd-page-setup-group" style="margin-top: 16px;">
...
﻿<div style="width: 272px; position: relative; top: 38%; margin: 0 auto;">
    <div style="margin-bottom: 5px;" data-bind="text: $root.getLocalization('Specify the report\'s title', 'ASPxReportsStringId.ReportDesigner_Wizard_SpecifyReportTitle')"></div>
...
﻿<div class="dxrd-wizard-page">
    <div class="dxrd-wizard-selectlabelproduct-page dxd-border-secondary">
        <div class="dxrd-wizard-selectlabelproduct-list">
            ...
            <div data-bind="dxSelectBox: { items: _labelData.labelProducts, displayExpr: 'name', value: _selectedLabelProduct, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
            ...
            <div data-bind="dxSelectBox: { dataSource: _labelDetails, displayExpr: 'name', value: _selectedLabelDetails, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
        </div>
...
﻿<script type="text/html" id="dxrd-rich-edit">
    <div style="width:100%; height: 100%" data-bind="css: className">
        <div data-bind="visible: visible">
            <!-- ko with: getToolbar() -->
            <!-- ko template: { name: template, data: $data }-->
            <!-- /ko -->
...
<script type="text/html" id="dxrd-richedit-toolbar">
    <div style="z-index: 0; position: absolute;" data-bind="dxPopover: {
        width: 'auto',
        height: 'auto',
...
<script type="text/html" id="dxrd-richEdit-toolbar-colorpicker">
    <div data-bind="dxColorBox: { value: value, popupPosition: { collision: 'flipfit flipfit' }, focusStateEnabled: false }"></div>
</script>

<script type="text/html" id="dxrd-rich-toolbar-combobox">
    <div data-bind="dxLocalizedSelectBox: { dataSource: items, value: value, focusStateEnabled: false, searchEnabled: !supportCustomValue, displayCustomValue: true,  acceptCustomValue: supportCustomValue, openOnFieldClick: !supportCustomValue }, dxValidator: { validationRules: validationRules }"></div>
</script><script type='text/html' id='dxrd-richedit-content'>
﻿<div data-bind="css:{ 'dxrd-intersect': !isValid() }" style="box-sizing: border-box; letter-spacing: normal; width:100%; height: 100%">
    <div data-bind="style: { display: isValid()? 'inline' : 'none' }">
        <div style="width:100%; height: 100%; vertical-align: top;" class="dxrd-control-content dxrd-richedit-readonly" data-bind="style: contentCss"></div>
    </div>
    <!-- ko if: !isValid() -->
...
﻿<div class="dxrd-control" data-bind="event: { dblclick: function() { $root.richInlineControl.show($element) } }, visible: selected() || focused(), css: {'dxrd-selected': selected, 'dxrd-focused': focused, 'dxrd-intersect': isIntersect, 'dxrd-locked': locked }, resizable: $root.resizeHandler, draggable: $root.dragHandler, styleunit: position, trackCursor: underCursor">
    <!-- ko if: selected() -->
