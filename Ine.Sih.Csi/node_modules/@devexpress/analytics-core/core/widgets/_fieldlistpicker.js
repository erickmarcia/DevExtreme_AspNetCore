...
var dxFieldListPicker = (function (_super) {
    ...
    function dxFieldListPicker($element, options) {
        var _this = _super.call(this, $element, _utils_1.extend(options, { showClearButton: true })) || this;
        ...
        if ('displayValue' in options) {
            _this._hasDisplayNameOption = true;
...
}(drop_down_box_1.default));
exports.dxFieldListPicker = dxFieldListPicker;
component_registrator_1.default('dxFieldListPicker', dxFieldListPicker);
