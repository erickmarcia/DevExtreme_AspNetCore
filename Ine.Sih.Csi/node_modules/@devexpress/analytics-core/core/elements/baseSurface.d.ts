...
export declare class SurfaceElementArea<M extends ElementViewModel> extends Disposable {
    _control: M;
...
export declare class SurfaceElementBase<M extends ElementViewModel> extends SurfaceElementArea<M> implements ISelectionTarget {
