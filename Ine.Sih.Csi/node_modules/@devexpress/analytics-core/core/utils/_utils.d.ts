...
export declare function getResizableOptions($element: Element, panelOffset: number, minWidth: number, position: string, startPosition: string, width?: ko.MaybeSubscribable<number>, disabled?: ko.MaybeSubscribable<boolean>): {
    starting: () => void;
    handles: string;
    stopped: () => undefined;
    stop: () => undefined;
