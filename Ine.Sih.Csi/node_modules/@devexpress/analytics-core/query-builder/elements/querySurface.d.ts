...
import { QueryViewModel } from './queryModel';
...
export declare class QuerySurface extends SurfaceElementBase<QueryViewModel> implements ISelectionTarget, ISurfaceContext {
