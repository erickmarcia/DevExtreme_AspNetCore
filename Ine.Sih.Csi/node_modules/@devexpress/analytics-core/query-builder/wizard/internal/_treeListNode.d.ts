...
export declare var defaultObjectDataSourceItemSpecifics: string;
export declare class TreeNodeBase implements IDataMemberInfo {
    name: string;
    displayName: string;
    specifics: string;
...
export declare class QueriesTreeNode extends ParameterTreeNode {
