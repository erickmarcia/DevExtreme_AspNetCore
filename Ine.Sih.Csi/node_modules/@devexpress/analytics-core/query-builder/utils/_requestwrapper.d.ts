...
import { ISelectStatementResponse } from './requestwrapper';
...
export declare function wrapRebuildResultSchema(callback?: (dataSource: SqlDataSource, queryName?: string, relationsEditing?: boolean) => JQueryPromise<{
...
export declare function serializeDataConnection(connection: SqlDataConnection): string;
