...
export declare var removeWinSymbols: boolean;
export declare var Globalize: any;
export declare var messages: {};
export declare var custom_localization_values: {};
...
export declare function applyLocalizationToDevExtreme(currentCulture: string): void;
