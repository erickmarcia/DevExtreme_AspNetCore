...
function applyLocalizationToDevExtreme(currentCulture) {
    ...
    var messagesByLocales = localization['message'].getMessagesByLocales();
    ...
    if (!specificLocaleMessages['dxList-selectAll'] && !neutralLocaleMessages['dxList-selectAll']) {
        var message = exports.messages['AnalyticsCoreStringId.SelectAll'];
        if (message) {
    ...
    localization.loadMessages(cultureJson);
}
exports.applyLocalizationToDevExtreme = applyLocalizationToDevExtreme;
