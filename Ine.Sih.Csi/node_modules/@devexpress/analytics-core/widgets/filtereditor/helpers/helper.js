...
var FilterEditorHelper = (function () {
    function FilterEditorHelper(serializer) {
        ...
        this.filterEditorOperators.date = [].concat(this.filterEditorOperators._common, [
            ...
            { name: 'Is later this year', insertVal: 'IsOutlookIntervalLaterThisYear()', emptyRightPart: true, value: function_1.FunctionOperatorType.IsOutlookIntervalLaterThisYear, type: function_1.FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsOutlookIntervalLaterThisYear' },
            { name: 'Is later this month', insertVal: 'IsOutlookIntervalLaterThisMonth()', emptyRightPart: true, value: function_1.FunctionOperatorType.IsOutlookIntervalLaterThisMonth, type: function_1.FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsOutlookIntervalLaterThisMonth' },
            ...
            { name: 'Is later this week', insertVal: 'IsOutlookIntervalLaterThisWeek()', emptyRightPart: true, value: function_1.FunctionOperatorType.IsOutlookIntervalLaterThisWeek, type: function_1.FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsOutlookIntervalLaterThisWeek' },
            ...
            { name: 'Is earlier this week', insertVal: 'IsOutlookIntervalEarlierThisWeek()', emptyRightPart: true, value: function_1.FunctionOperatorType.IsOutlookIntervalEarlierThisWeek, type: function_1.FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsOutlookIntervalEarlierThisWeek' },
            ...
            { name: 'Is earlier this month', insertVal: 'IsOutlookIntervalEarlierThisMonth()', emptyRightPart: true, value: function_1.FunctionOperatorType.IsOutlookIntervalEarlierThisMonth, type: function_1.FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsOutlookIntervalEarlierThisMonth' },
            { name: 'Is earlier this year', insertVal: 'IsOutlookIntervalEarlierThisYear()', emptyRightPart: true, value: function_1.FunctionOperatorType.IsOutlookIntervalEarlierThisYear, type: function_1.FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsOutlookIntervalEarlierThisYear' },
...
exports.DefaultFilterEditorHelper = FilterEditorHelper;
