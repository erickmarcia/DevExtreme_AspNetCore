...
var AccessibilityKeyboardHelperBase = (function (_super) {
    ...
    AccessibilityKeyboardHelperBase.prototype.bindHandler = function (elementContainer) {
        ...
        var handler = function (e) {
            var target = e.target;
            if (target.classList.contains(_this.controlElementClassName) && _this.processChildrenShortcut(e, _this.getIndexByElement(target))
    ...
    AccessibilityKeyboardHelperBase.prototype.liveRegion = function () {
        var _this = this;
