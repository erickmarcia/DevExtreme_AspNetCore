...
declare module DevExpress.Analytics.Widgets {
	...
	export type BaseEditors = 'bool' | 'boolSelect' | 'numeric' | 'modificators' | 'combobox' | 'comboboxEditable' | 'text' | 'image' | 'file' | 'commonCollection' | 'font' | 'stringArray' | 'guid' | 'date' | 'borders' | 'objecteditorCustom' | 'objecteditor' | 'inplaceObjectEditor' | 'field' | 'dataMember' | 'filterEditor' | 'formatEditor' | 'expressionEditor' | 'customColorEditor' | 'sbyte' | 'decimal' | 'int64' | 'int32' | 'int16' | 'single' | 'double' | 'byte' | 'uint16' | 'uint32' | 'uint64';
...
declare module DevExpress.Analytics.Internal {
	...
	export function applyLocalizationToDevExtreme(currentCulture: string): void;
...
declare module DevExpress.Analytics.Internal {
	...
	export var ShowMessage: (msg: string, type?: string, displayTime?: number, debugInfo?: string) => void;
	export var _setShowMessageFunc: (func: any) => any;
	export var _resetShowMessageFunc: () => (msg: string, type?: string, displayTime?: number, debugInfo?: string) => void;
...
declare module DevExpress.Analytics.Internal {
	...
	export function getResizableOptions($element: Element, panelOffset: number, minWidth: number, position: string, startPosition: string, width?: ko.MaybeSubscribable<number>, disabled?: ko.MaybeSubscribable<boolean>): {
	    starting: () => void;
	    handles: string;
	    stopped: () => undefined;
	    stop: () => undefined;
...
declare module DevExpress.Analytics.Internal {
	...
	export function roundingTwoDecimals(value: number, useFloor?: boolean): number;
...
declare module DevExpress.Analytics.Internal {
	...
	export function findNextSelection(removedElement: ISelectionTarget): ISelectionTarget;
...
declare module DevExpress.Analytics.Widgets.Internal {
	...
	export class dxFieldListPicker extends dxDropDownBox {
	    ...
	    constructor($element: JQuery<HTMLElement>, options?: any);
	    _showDropDown(): void;
...
declare module DevExpress.Analytics.Widgets.Internal {
	...
	export function insertInFunctionDisplay(addins: any): Array<IExpressionEditorFunction>;
...
declare module DevExpress.Analytics.Wizard.Internal {
	...
	export class DBSchemaItemsProvider implements IItemsProvider {
	    private _callBack;
	    private _tables;
	    private _views;
	    private _procedures;
...
declare module DevExpress.Analytics.Wizard.Internal {
	...
	export class TreeNodeBase implements IDataMemberInfo {
	    name: string;
	    displayName: string;
	    specifics: string;
	...
	export class FieldTreeNode extends TreeNodeBase {
	    constructor(name: string, displayName: string, specifics: string, isChecked: boolean, path: string, afterCheckToggled?: (node: TreeNodeBase) => void);
	    path: string;
	    visible: ko.Observable<boolean>;
	    isComplex: boolean;
	}
...
declare module DevExpress.Analytics.Wizard.Internal {
	...
	export function subscribeProperties(properties: Array<ko.Observable<any> | ko.Computed<any>>, onChange: () => void): any[];
...
declare module DevExpress.Analytics.Widgets.Internal {
    ...
    import CriteriaOperatorSurface = DevExpress.Analytics.Widgets.Filtering.CriteriaOperatorSurface;;
    import CriteriaOperator = DevExpress.Analytics.Criteria.CriteriaOperator;;
	export class FilterEditorAddOn {
	    private _popupService;
	    private _action;
	    private _updateActions;
...
declare module DevExpress.Analytics.Widgets {
	...
	export var DefaultFilterEditorHelper: typeof FilterEditorHelper;
